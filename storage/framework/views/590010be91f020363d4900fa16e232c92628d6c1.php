                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="nama" class="form-control" placeholder="Masukan Nama Pengirim.." required>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="col-md-12">
                        ...
                        <div class="mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="telp" class="form-control" placeholder="Masukan Kontak.." required>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="col-md-12">
                                <label for="email">E-Mail</label>
                                <input type="email" name="email" class="form-control" placeholder="Masukan E-Mail (opsional)">
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="<?php echo e(route('pengirim.update', $item->id)); ?>" method="post">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <div class="col-md-12">
                                    <label for="nama">Nama Pengirim</label>
                                    <input type="text" name="nama" class="form-control" value="<?php echo e($nama); ?>" placeholder="Masukan Nama Pengirim.." required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="col-md-12">
                                    <label for="alamat">Alamat</label>
                                    <textarea name="alamat" class="form-control" required><?php echo e($alamat); ?></textarea>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="col-md-12">
                                    <label for="telp">Kontak</label>
                                    <input type="text" name="telp" value="<?php echo e($telp); ?>" class="form-control" placeholder="Masukan Kontak.." required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="col-md-12">
                                    <label for="email">E-Mail</label>
                                    <input type="email" name="email" value="<?php echo e($email); ?>" class="form-control" placeholder="Masukan E-Mail (opsional)">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\e-arsip_bpkad\resources\views/pages/admin/pengirim/index.blade.php ENDPATH**/ ?>
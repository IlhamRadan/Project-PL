...
<?php $__env->startSection('container'); ?>
    <main>
        ...
        <div class="container-xl px-4 mt-4">
            ...
            <nav class="nav nav-borders text-success">
                <a class="nav-link <?php echo e(request()->is('admin/setting/password') ? 'active ms-0' : ''); ?>"
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card mb-4">
                        <div class="card-header text-green">Ubah Password</div>
                        <div class="card-body">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <button class="btn btn-green" type="submit">Perbarui Password</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-arsip.bpkad\resources\views/pages/admin/user/change-password.blade.php ENDPATH**/ ?>
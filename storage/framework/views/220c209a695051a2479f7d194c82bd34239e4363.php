<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <a class="nav-link <?php echo e((request()->is('admin/letter/surat-keluar')) ? 'active' : ''); ?>" href="<?php echo e(route('surat-keluar')); ?>">
...
</nav><?php /**PATH D:\laravel-app\surat-app\resources\views/includes/sidebar-admin.blade.php ENDPATH**/ ?>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="letter_type" class="form-control" required>
                                            ...
                                            <option value="SPM" <?php echo e(($item->letter_type == 'SPM')? 'selected':''); ?>>SPM</option>
                                            <option value="SPP" <?php echo e(($item->letter_type == 'SPP')? 'selected':''); ?>>SPP</option>
                                            <option value="SP2D" <?php echo e(($item->letter_type == 'SP2D')? 'selected':''); ?>>SP2D</option>
                                        </select>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($item->date_received); ?>" name="date_received" required>
                                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\surat-app\resources\views/pages/admin/letter/edit.blade.php ENDPATH**/ ?>
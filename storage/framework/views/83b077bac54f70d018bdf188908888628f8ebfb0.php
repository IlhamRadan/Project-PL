            ...
            <div class="row">
                <div class="col-xl-4">
                    ...
                    <div class="card mb-4 mb-xl-0">
                        <div class="card-header text-green">Foto Profil</div>
                        <div class="card-body text-center">
                            ...
                            <input type="hidden" name="id" value="<?php echo e($user->id); ?>">
                                ...
                                />
                                <button class="btn btn-success" type="button" onclick="thisFileUpload();">Unggah Photo</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\surat-app\resources\views/pages/admin/user/profile.blade.php ENDPATH**/ ?>
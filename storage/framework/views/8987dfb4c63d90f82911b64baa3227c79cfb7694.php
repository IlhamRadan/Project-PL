...
<?php $__env->startSection('container'); ?>
    <main>
        ...
        <div class="container-fluid px-4">
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('surat.store')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row gx-4">
                    <div class="col-lg-9">
                        <div class="card mb-4">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="tipe_surat" class="form-control" required>
                                            ...
                                            <option value="SPM" <?php echo e((old('tipe_surat') == 'SPM')? 'selected':''); ?>>SPM</option>
                                            <option value="SPP" <?php echo e((old('tipe_surat') == 'SPP')? 'selected':''); ?>>SPP</option>
                                            <option value="SP2D" <?php echo e((old('tipe_surat') == 'SP2D')? 'selected':''); ?>>SP2D</option>
                                        </select>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('no_surat')); ?>" name="no_surat" placeholder="Nomor Surat.." required>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('tgl_surat')); ?>" name="tgl_surat" required>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('tgl_diterima')); ?>" name="tgl_diterima" required>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('perihal')); ?>" name="perihal" placeholder="Perihal.." required>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3 row">
                                    <label for="id_bidang" class="col-sm-3 col-form-label">Bidang/SKPD</label>
                                    <div class="col-sm-9">
                                        <select name="id_bidang" class="form-control selectx" required>
                                            ...
                                            <?php $__currentLoopData = $bidangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bidang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($bidang->id); ?>" <?php echo e((old('id_bidang') == $bidang->id)? 'selected':''); ?>><?php echo e($bidang->nama); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <?php $__errorArgs = ['id_bidang'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="col-sm-9">
                                        <select name="id_pengirim" class="form-control selectx" required>
                                            ...
                                            <?php $__currentLoopData = $pengirims; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengirim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($pengirim->id); ?>" <?php echo e((old('id_pengirim') == $pengirim->id)? 'selected':''); ?>><?php echo e($pengirim->nama); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('file_surat')); ?>" name="file_surat" required>
                                        <div id="file_surat" class="form-text">Tipe file .pdf, .jpeg, .jpg, atau .png</div>
                                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-arsip.bpkad\resources\views/pages/admin/surat/create.blade.php ENDPATH**/ ?>
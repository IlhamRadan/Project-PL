        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createModal">Tambah Data Bidang/Sub Bidang</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="nama" class="form-control" placeholder="Masukan Nama Bidang/Sub Bidang.." required>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="<?php echo e(route('bidang.update', $item->id)); ?>" method="post">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <div class="col-md-12">
                                    <label for="post_id">Nama Bidang/Sub Bidang</label>
                                    <input type="text" name="nama" value="<?php echo e($nama); ?>" class="form-control" placeholder="Masukan Nama Bidang/Sub Bidang.." required>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\e-arsip_bpkad\resources\views/pages/admin/bidang/index.blade.php ENDPATH**/ ?>
                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-8 col-xxl-12">
                                    <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                        <h1 class="text-green">Selamat Datang <?php echo e(Auth::user()->name); ?> !</h1>
                                        <p class="text-gray-700 mb-0">Di Website Aplikasi E-Arsip BPKAD Kabupaten Bogor</p>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-xl-4 mb-4">
                    <div class="card text-white h-100" id="cardSPM">
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between small">
                            <a class="text-white stretched-link" href="<?php echo e(route('surat-pm')); ?>">Selengkapnya</a>
                ...
                <div class="col-lg-12 col-xl-4 mb-4">
                    <div class="card bg-teal text-white h-100" id="cardSPP">
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between small">
                            <a class="text-white stretched-link" href="<?php echo e(route('surat-pp')); ?>">Selengkapnya</a>
                            <div class="text-white"><i class="fas fa-angle-right"></i></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12 col-xl-4 mb-4">
                    <div class="card text-white h-100" id="cardSP2D">
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between small">
                            <a class="text-white stretched-link" href="<?php echo e(route('surat-p2d')); ?>">Selengkapnya</a>
                            <div class="text-white"><i class="fas fa-angle-right"></i></div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\surat-app\resources\views/pages/admin/dashboard.blade.php ENDPATH**/ ?>
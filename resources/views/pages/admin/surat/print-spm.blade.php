...
<html lang="en">
  <head>
    ...
    <title>Cetak Laporan SPM - E-Arsip BPKAD</title>
  </head>
  <body>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @php
                                $no=1;
                            @endphp
                            @foreach ($item as $surat)
                            <tr>
                                <td style="font-family: 'Times New Roman', Times, serif">{{ $no++ }}</td>
                                    <td style="font-family: 'Times New Roman', Times, serif">{{ $surat->no_surat }}</td>
                                    <td style="font-family: 'Times New Roman', Times, serif">{{ $surat->pengirim->nama }}</td>
                                    <td style="text-align: center; font-family: 'Times New Roman', Times, serif">{{ date('d-m-Y', strtotime($surat->tgl_surat)) }}
                                    </td>
                                    <td style="text-align: center; font-family: 'Times New Roman', Times, serif">{{ date('d-m-Y', strtotime($surat->tgl_diterima)) }}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>

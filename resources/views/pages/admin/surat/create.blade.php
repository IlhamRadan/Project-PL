                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="tipe_surat" class="form-control" required>
                                            ...
                                            <option value="SPM" {{ (old('tipe_surat') == 'SPM')? 'selected':''; }}>SPM</option>
                                            <option value="SPP" {{ (old('tipe_surat') == 'SPP')? 'selected':''; }}>SPP</option>
                                            <option value="SP2D" {{ (old('tipe_surat') == 'SP2D')? 'selected':''; }}>SP2D</option>
                                        </select>
                                    </div>
                                    @error('tipe_surat')
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" class="form-control @error('tgl_surat') is-invalid @enderror" value="{{ old('tgl_surat') }}" name="tgl_surat" required>
                                    </div>
                                    @error('tgl_surat')
                                        <div class="invalid-feedback">
                                            {{ $message; }}
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" class="form-control @error('tgl_diterima') is-invalid @enderror" value="{{ old('tgl_diterima') }}" name="tgl_diterima" required>
                                    </div>
                                    @error('date_received')
                                        <div class="invalid-feedback">
                                            {{ $message; }}
                                    ...
                                    <div class="col-sm-9">
                                        <select name="id_pengirim" class="form-control selectx" required>
                                            ...
                                            @foreach ($pengirims as $pengirim)
                                                <option value="{{ $pengirim->id }}" {{ (old('id_pengirim') == $pengirim->id)? 'selected':''; }}>{{ $pengirim->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('id_pengirim')
